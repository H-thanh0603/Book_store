...
export default async function Home() {
  ...
  const modules = [
    ...
    },
    {
      ...
      desc: "Tra cứu hóa đơn VAT, xem chi tiết và hủy hóa đơn phát hành từ POS",
      href: "/invoices",
      icon: Receipt,
    ...
    },
    {
      ...
      href: "/stores",
      icon: MapPin,
      color: "from-[#1e3a5f] to-[#18253f]",
      badge: "Cửa hàng",
    },
    {
      title: "Gift Card & Kiểm Kê",
      desc: "Phát hành thẻ quà tặng và theo dõi số dư, nạp thêm, đổi điểm",
      href: "/gift-cards",
      icon: Gift,
