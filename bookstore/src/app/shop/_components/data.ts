...
export const featuredCampaigns: FeaturedCampaign[] = [
  {
    ...
    bg: "from-[#2b2118] via-[#3d2b1f] to-[#1c1917]",
    accent: "from-[#e8dac5] via-[#f3e5d0] to-white",
  ...
  },
  {
    ...
    bg: "from-[#1e2b23] via-[#2a3a2e] to-[#1c1917]",
    accent: "from-[#d8e2dc] via-[#f0f4f1] to-white",
  ...
  },
  {
    ...
    bg: "from-[#2e2620] via-[#3a2f26] to-[#1c1917]",
    accent: "from-[#e8dac5] via-[#f3e5d0] to-white",
  ...
  },
  {
    ...
    bg: "from-[#33231c] via-[#40291e] to-[#1c1917]",
    accent: "from-[#e8dac5] via-[#f3e5d0] to-white",
